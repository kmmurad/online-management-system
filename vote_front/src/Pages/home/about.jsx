        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg mb-8">
            ...
            <p className="text-gray-600">
              ...
              improving the election process. We believe in the power of
              technology to create a more inclusive and democratic society.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg">
            ...
            <p className="text-gray-600">
              We are committed to providing a reliable and user-friendly
              platform that ensures every vote counts. Our system is designed to
              be accessible, secure, and efficient, making it the ideal choice
